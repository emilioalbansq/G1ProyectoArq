...
plt.savefig('robo_autopartes_evolucion.png')
print("\nGráfico guardado exitosamente como 'robo_autopartes_evolucion.png'")
#+end_src
...
Gráfico guardado como 'robo_autopartes_evolucion.png'
#+end_example
...
[[file:robo_autopartes_evolucion.png]]
